...
class Murmur
{
    ...
    public static function hash3_int(string $key, int $seed = 0): int
    {
        ...
        for ($bytes = $klen - ($remainder = $klen & 3); $i < $bytes; ) {
            ...
            $k1 =
                ($k1 << 15) |
                ($k1 >= 0 ? $k1 >> 17 : (($k1 & 0x7fffffff) >> 17) | 0x4000);
            $k1 =
            ...
            $h1 =
                ($h1 << 13) |
                ($h1 >= 0 ? $h1 >> 19 : (($h1 & 0x7fffffff) >> 19) | 0x1000);
            $h1b =
                (($h1 & 0xffff) * 5 +
                    (((($h1 >= 0
                        ? $h1 >> 16
                        : (($h1 & 0x7fffffff) >> 16) | 0x8000) *
                        5) &
                        0xffff) <<
                        16)) &
                0xffffffff;
